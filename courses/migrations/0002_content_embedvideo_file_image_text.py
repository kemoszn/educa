# Generated by Django 2.0.5 on 2020-04-03 10:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'model__in': ('text', 'embedvideo', 'image', 'file')}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='embedvideo_related', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
